...
export default function SearchScreen() {
  ...
  // Auto-focus the input when opening the page
  useEffect(() => {
          ...
          <View style={{padding: 15}}>
            ...
            {filteredShops.length === 0 && (
              <View style={{marginTop: 50, alignItems: 'center'}}>
                ...
                <TouchableOpacity onPress={() => setActiveCategory('All')}><Text style={{color: COLORS.primary, marginTop: 10}}>Clear Filters</Text></TouchableOpacity>
              </View>
            )}
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  searchContainer: { 
    ...
    borderRadius: 12, paddingHorizontal: 10, height: 45, marginLeft: 10 
  },
  input: { flex: 1, color: COLORS.dark, fontSize: 16 },
  categoriesContainer: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.05)' },
  catPill: { 
    paddingVertical: 6, paddingHorizontal: 16, borderRadius: 20, backgroundColor: COLORS.white, 
